...
R_MIN, R_MAX, R_RES = 80, 105, 0.2  # SetArenaR valuesyulTHETA_MIN, THETA_MAX, THETA_RES = -1, 1, 1  # SetArenaTheta values
...
# each point is  about 0.101 seconds in 1.2+
