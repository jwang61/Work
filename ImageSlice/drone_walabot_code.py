...
class WalabotPanel(tk.LabelFrame):
    ...
    def __init__(self, master):
        ...
        self.rMax = self.WalabotParameter(self, 'R     Max', 1, 10000, 500.0)
        self.rRes = self.WalabotParameter(self, 'R     Res', 0.1, 1000, 2.0)
        self.tMin = self.WalabotParameter(self, 'Theta Min', -90, 90, -5.0 )
        self.tMax = self.WalabotParameter(self, 'Theta Max', -90, 90, 5.0)
        self.tRes = self.WalabotParameter(self, 'Theta Res', 0.1, 10, 1.0)
        self.pMin = self.WalabotParameter(self, 'Phi   Min', -90, 90, -5.0)
        self.pMax = self.WalabotParameter(self, 'Phi   Max', -90, 90, 5.0)
        self.pRes = self.WalabotParameter(self, 'Phi   Res', 0.1, 10, 1.0)
